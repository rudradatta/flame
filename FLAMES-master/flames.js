    ...
    if(orfirst!="")
    {
            ...
            if(second != "")
            {
                document.getElementById("tablid").style.display = 'block';
                    ...
                    {
                            //res="FRIENDS";
							document.getElementById("msg").innerHTML = 'FRIENDS...."JUST FRIENDS"';
							document.getElementById("msg").style.color='blue';                  
                    }
                    else if(ar=="L")
                    {
                            //res="LOVER";
							document.getElementById("msg").innerHTML = 'LOVER....."Maybe...RELATIONSHIT"';
							document.getElementById("msg").style.color='#FF0080';
                    }
                    else if(ar=="A")
                    {
                            //res="AFFECTION";
							document.getElementById("msg").innerHTML = 'AFFECTION...."HAHA"';
							document.getElementById("msg").style.color='#DBA901';
                    } 
                    else if(ar=="M")
                    {
                            //res="MARRIAGE";
							document.getElementById("msg").innerHTML = 'MARRIAGE...SHIT HAPPENS BRO';
							document.getElementById("msg").style.color='green';
                    }
                    else if(ar=="E")
                    {	
                            //res="ENEMY";
							document.getElementById("msg").innerHTML = 'Enemy ...."Better than MARRIAGE..RIGHT?"';
							document.getElementById("msg").style.color='red';
                    }
                    else if(ar=="S")
                    {
                            //res="SISTER";
							document.getElementById("msg").innerHTML = 'SISTER... "You Alive Bro?"';
